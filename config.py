...
DEFAULT_SETTINGS = {
    ...
    # ── источник видео ────────────────────────────────────────────────────────
    # Пусто = источник не выбран. По умолчанию никакое видео не запускается —
    # оператор выбирает источник в интерфейсе (веб-камера / файл / RTSP).
    "video_source": "",              # "" — нет источника; "0" — USB-камера; RTSP/путь к файлу
